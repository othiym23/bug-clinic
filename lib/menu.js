...
module.exports = function (opts) {
  ...
  (opts.ready || opts.names || []).forEach(function (name) {
  ...
  if (opts.ready && opts.names) {
    var m = "[TEXT ONLY]\n";
    opts.names.filter(function (n) {
      return opts.ready.indexOf(n.split(" ")[0]) === -1;
    }).forEach(function (u) {
      menu.write(u + Array(66 - m.length - u.length + 1).join(" ") + m);
    });
  }
  menu.write("-----------------\n");
  menu.add("HELP");
